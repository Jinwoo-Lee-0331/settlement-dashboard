...
# 심야는 자정을 넘겨도 같은 근무의 연장이므로 00:00~06:59도 심야로 카운트한다.
MISSION_BUCKETS = ["오전점심피크", "오후논피크", "저녁피크", "심야"]
BAEMIN_BUCKET_RANGES = [
    ("오전점심피크", dt_time(7, 0), dt_time(12, 59, 59)),
    ("오후논피크", dt_time(13, 0), dt_time(16, 59, 59)),
    ("저녁피크", dt_time(17, 0), dt_time(19, 59, 59)),
    ("심야", dt_time(20, 0), dt_time(23, 59, 59)),
    ("심야", dt_time(0, 0), dt_time(6, 59, 59)),
]
